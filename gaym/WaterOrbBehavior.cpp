...
WaterOrbBehavior::WaterOrbBehavior()
    : m_SkillData(WaterSkillPresets::WaterOrb())
{
}

void WaterOrbBehavior::Execute(GameObject* caster, const DirectX::XMFLOAT3& targetPosition, float damageMultiplier)
{
    m_bIsFinished = true;
