...
enum BossEventType : int {
  BOSS_EVENT_NONE = 0,
  BOSS_EVENT_INTRO = 1,
  BOSS_EVENT_PHASE_CHANGE = 2,
  BOSS_EVENT_DEATH = 3,
  BossEventType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  BossEventType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool BossEventType_IsValid(int value);
constexpr BossEventType BossEventType_MIN = BOSS_EVENT_NONE;
constexpr BossEventType BossEventType_MAX = BOSS_EVENT_DEATH;
constexpr int BossEventType_ARRAYSIZE = BossEventType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* BossEventType_descriptor();
template<typename T>
inline const std::string& BossEventType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, BossEventType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function BossEventType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    BossEventType_descriptor(), enum_t_value);
}
inline bool BossEventType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, BossEventType* value) {
...
template <> struct is_proto_enum< ::Protocol::BossEventType> : ::std::true_type {};
template <>
